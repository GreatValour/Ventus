!(function (e) {
  ...
  function (e, t) {
    e.exports =
      "//static.hsappstatic.net/HubspotToolsMenu/static-1.191/js/sprocket_white.svg";
  },
  function (e, t) {
    e.exports =
      "//static.hsappstatic.net/HubspotToolsMenu/static-1.191/js/sprocket_orange.svg";
  },
  function (e, t) {
    e.exports =
      "//static.hsappstatic.net/HubspotToolsMenu/static-1.191/css/toolsmenu.css";
  },
  function (e, t, n) {
    "use strict";
    n.r(t);
    ...
    class m {
          ...
          if (o.has_permission) {
            ...
            this.httpGet(o, (o) => {
              ...
              "content-membership" === e
                ...
                : this.getAppLinks(e, t, this.portalId);
      ...
      getAppLinks(e, t, n) {
        this.jsonp(
          `${this.baseUrl}/content-tools-menu/api/v1/tools-menu/${e}/${t}/actions?portalId=${n}`,
          (e) => {
      ...
      setUpLocalDevUrl() {
        this.localDevPromise = new Promise((e, t) => {
          if (
            !this.permissionObj.permissions.includes(
              "CAN_OPEN_LOCAL_DEVELOPMENT"
            )
          )
            return e(!1);
          ...
          const i = {
            ...
            r = Object.keys(i)
              .map((e) => `${e}=${i[e]}`)
              .join("&");
          return fetch("http://localhost:1442/check-if-local-dev-server?" + r)
            .then((e) => {
    ...
    const v = () => {
      const e = window.location,
        { port: t, hostname: n, pathname: o } = e,
